export const strings = {
  ...
  client: {
    ...
    updatingDashboard: 'Atualizando resumo e gráfico...',
    executiveSummaryTitle: 'Resumo executivo',
    statusCountsTitle: 'Produtos por status',
    topRiskTitle: 'Top 3 itens em risco financeiro',
    noRiskProducts: 'Nenhum produto em risco identificado.',
    riskScoreHint: 'faturamento perdido + capital imobilizado',
    extremesTitle: 'Extremos da carteira',
    minStockDaysLabel: 'Menor dias de estoque',
    maxStockDaysLabel: 'Maior dias de estoque',
    minIddLabel: 'Menor IDD',
    maxIddLabel: 'Maior IDD',
    minProjectedRevenueLabel: 'Menor faturamento projetado',
    maxProjectedRevenueLabel: 'Maior faturamento projetado',
    maxTiedUpCapitalLabel: 'Maior capital imobilizado',
    maxLostRevenueLabel: 'Maior faturamento perdido',
    exportActiveTitle: 'Planilha ativa',
    exportHistoryTitle: 'Histórico de importações',
    exportCompletedAt: 'Concluída em',
    downloadSpreadsheet: 'Baixar planilha',
    noExportVersions: 'Nenhuma planilha disponível para exportação.',
    noExportHistory: 'Nenhuma importação anterior com arquivo disponível.',
    exportPdfTitle: 'Relatório PDF',
    exportPdfDescription:
      'Gera um relatório integral da importação ativa com resumo executivo, produtos por status e gráfico de IDD.',
    exportPdfButton: 'Gerar relatório PDF',
    exportPdfGenerating: 'Gerando PDF...',
